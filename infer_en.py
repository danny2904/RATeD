...
def main():
    while True:
        clear_screen()
        print("          RATeD-V ENGLISH - RESEARCH PIPELINE")
        print("="*60)
        ...
        # Build Command
        script = "experiments/english/proposed/04_cascaded_verify_en.py"
        model_path = "experiments/english/baseline/results/RATeD_E1_baseline/best_model.pth"
        
        cmd = [sys.executable, script, "--model_path", model_path, "--provider", provider]
