...
ENGLISH_SLANG_KB = """
GROUP 1: HATE (TARGETED DEHUMANIZATION)
- SLURS: "nigger", "kike", "paki", "coon", "spic", "beaner", "chink", "muzzie".
- DEHUMANIZATION: Comparing PROTECTED GROUPS to "vermin", "cockroaches", "animals", "shit", "parasites", "virus", "monkeys".
- AGGRESSIVE GENERALIZATIONS: "illegal immigrants are criminals", "moslem terrorists", "jewish profit from war".
- IDEOLOGY: Promoting "White Supremacy", "KKK", "White Sharia", "Nazi/NSDAP".

GROUP 2: OFFENSIVE (PERSONAL INSULTS & TOXICITY)
- PERSONAL INSULTS: Any attack on a person's intelligence or character: "retard", "idiot", "stupid", "pos", "asshole", "trash", "clown", "dumbass", "bitch", "hoe", "cunt", "failure".
- AGGRESSIVE BEHAVIOR: "stfu", "fucking hate you", "get out", "piece of shit", "waste of space".
- NON-TARGETED SLURS: Using slurs to insult individuals rather than whole identity groups.

GROUP 3: NORMAL (SAFE & POLICY CRITICISM)
- SYSTEM CRITICISM: Strong criticism of IDEAS, POLITICS, or SYSTEMS (e.g., "this policy is trash", "this idea is retarded") can be NORMAL.
- IDENTITY MENTION: Neutral descriptive use of "muslims", "black", "gay".
- RECLAIMED: "nigga" (casual AAE).
- EMPHASIS: "fucking love this", "holy shit".
- RULE: If an insult is directed AT A PERSON, it MUST be OFFENSIVE.
"""
...
2. RATIONALE EXTRACTION (CRITICAL FOR SPAN IoU): 
   - Extract WHOLE SEMANTIC UNITS (Adjective + Noun).
   - If the text is "this stupid person", extract "stupid person", NOT just "stupid".
   - Capture the full dehumanizing phrase (e.g., "illegal immigrants are criminals").
