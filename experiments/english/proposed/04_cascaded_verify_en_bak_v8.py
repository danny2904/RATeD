...
ENGLISH_SLANG_KB = """
GROUP 1: HATE (TARGETED DEHUMANIZATION & AGGRESSIVE GENERALIZATION)
- SLURS: "nigger", "kike", "paki", "coon", "spic", "beaner", "chink", "muzzie".
- DEHUMANIZATION: Comparing groups to "vermin", "cockroaches", "animals", "shit", "parasites", "virus", "monkeys".
- AGGRESSIVE GENERALIZATIONS: "illegal immigrants are criminals/rapists", "moslem terrorists", "jewish profit from war". These are HATE due to dehumanizing stereotypes.
- EXTREME TARGETING: "dating monkeys", "limitless parasites", "plantation slaves".
- IDEOLOGY: Promoting "White Supremacy", "KKK", "White Sharia", "Nazi/NSDAP".

GROUP 2: OFFENSIVE (GENERAL TOXICITY, INSULTS & INDIVIDUAL SLURS)
- INDIVIDUAL INSULTS: "retard", "idiot", "stupid", "pos", "asshole", "trash", "clown", "dumbass", "bitch", "hoe", "cunt".
- AGGRESSIVE BEHAVIOR: "stfu", "fucking hate you", "get out", "piece of shit".
- NON-TARGETED SLURS: Using slurs as general insults to a person (not a group).
- TOPICS: Neutral mention of "illegal immigrants" or "muslims" without dehumanizing metaphors.

GROUP 3: NORMAL (SAFE, DESCRIPTIVE & HEATED DEBATE)
- HEATED DEBATE: Strong criticism of IDEAS, POLITICS, or BEHAVIOR (e.g., "this policy is retarded", "you are missing the point dumbass") is often NORMAL if no protected group is targeted.
- RECLAIMED: "nigga" (casual African American context).
- NEUTRAL: Using identity words ("muslims", "black", "gay") neutrally.
...
2. RATIONALE EXTRACTION (CRITICAL FOR SPAN IoU): 
   - Extract WHOLE LOGICAL UNITS that justify your label.
   - For HATE/OFFENSIVE: If the attack is "dirty illegal immigrants", extract the whole unit "dirty illegal immigrants", NOT just "dirty". 
   - If a sentence is toxic as a whole, extract the most toxic clause.
