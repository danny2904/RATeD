...
ENGLISH_SLANG_KB = """
GROUP 1: HATE (TARGETED GROUP DEHUMANIZATION)
- RULE: Must target a MULTIPLE-PERSON IDENTITY GROUP (Race, Religion, Nationality).
- DEHUMANIZATION: Comparing an entire group to "vermin", "cockroaches", "animals", "shit", "parasites", "virus".
- GENERALIZATIONS: "Illegal immigrants are criminals", "Moslem terrorists". 
- SLURS (Primary): "nigger", "kike", "paki", "coon", "spic", "beaner", "chink".

GROUP 2: OFFENSIVE (PERSONAL DEHUMANIZATION & INSULTS)
- RULE: Targeted at INDIVIDUALS or non-protected groups.
- INDIVIDUAL DEHUMANIZATION: Calling a person a "cockroach", "vermin", "animal", "monkey", or "piece of shit".
- PERSONAL ATTACKS: "retard", "idiot", "stupid", "pos", "asshole", "trash", "clown", "dumbass", "bitch", "hoe", "cunt".
- AGGRESSIVE: "stfu", "fucking hate you", "get out".

GROUP 3: NORMAL (SAFE & DISCUSSIONS)
- CRITICISM: Criticizing ideas or systems.
- IDENTITY: Neutral descriptive mention of groups.
...
2. RATIONALE EXTRACTION (CRITICAL FOR SPAN IoU): 
   - Extract DENSE SEMANTIC BLOCKS that justify the label.
   - For HATE/OFFENSIVE: Spans should typically cover 20-40% of the toxic sentence to include adjectives, nouns, and verbs.
   - NEVER extract single words if they are part of a toxic phrase (e.g., extract "dirty immigrants", NOT just "dirty").
   - If the toxicity is spread throughout, extract the whole attacking clause.
