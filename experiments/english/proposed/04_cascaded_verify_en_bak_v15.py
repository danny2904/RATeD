...
ENGLISH_SLANG_KB = """
GROUP 1: HATE (TARGETED PROTECTED GROUP DEHUMANIZATION)
- PROTECTED GROUPS: Attacks on Race, Religion, Disability, or Sexuality.
- HARD SLURS: "nigger", "kike", "paki", "coon", "spic", "chink".
- METAPHORS: "vermin", "cockroaches", "animals", "parasites", "virus".
- RULE: Must target an entire group, not just an individual.

GROUP 2: OFFENSIVE (SOFT SLURS & PERSONAL INSULTS)
- SOFT SLURS: "bitch", "hoe", "cunt", "pussy", "retard", "faggot" (if used as general insult).
- PERSONAL ATTACKS: "idiot", "stupid", "pos", "asshole", "trash", "dumbass".
- AGGRESSIVE: "stfu", "fucking hate you", "get out".
- RULE: Use OFFENSIVE for targeted insults to a person's character or appearance.

GROUP 3: NORMAL (SAFE & NON-TARGETED)
- CRITICISM: Criticizing ideas or systems using strong language ("this is trash") without personal attacks.
...
2. RATIONALE EXTRACTION (CRITICAL FOR SPAN IoU): 
   - Extract the MINIMAL TOXIC CORE of the sentence.
   - Do NOT include neutral words like "the", "and", "is", "a" unless they are part of a slur phrase.
   - For HATE/OFFENSIVE: Focus on specific slurs, dehumanizing nouns, and sharp adjectives.
   - Example: For "you are a dirty immigrant", extract "dirty immigrant", NOT the whole sentence.
