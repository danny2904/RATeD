...
- SLURS (Primary): "nigger", "kike", "paki", "coon", "spic", "beaner", "chink", "muzzie", "faggot".
- DEHUMANIZATION: Comparing PROTECTED GROUPS to "vermin", "cockroaches", "animals", "shit", "parasites", "virus", "monkeys".
- RULE: Must target a COLLECTIVE IDENTITY (Race, Religion, Gender, Disability).
...
- RULE: If an insult is directed AT A PERSON's character or intelligence, it is OFFENSIVE.
- TOPICS: General mention of controversial themes without group-level dehumanization.

GROUP 3: NORMAL (SAFE & POLICY CRITICISM)
- SYSTEM CRITICISM: Strong criticism of IDEAS, POLITICS, or SYSTEMS (e.g., "this policy is trash").
- IDENTITY: Neutral descriptive use of identity groups.
- RECLAIMED: "nigga" (casual AAE context).
...
2. RATIONALE EXTRACTION (CRITICAL FOR SPAN IoU): 
   ...
   - Capture the core toxic context precisely.
