...
ENGLISH_SLANG_KB = """
GROUP 1: HATE (STRICT PROTECTED GROUP TARGETING)
- RULE: Must involve a PROTECTED IDENTITY (Race, Religion, Sexuality, Disability) AND use dehumanizing metaphors or explicit violent threats.
- SLURS: Only use HATE if the slur targets a group (e.g., "all [slur] should die").
- METAPHORS: Comparing groups to "vermin", "cockroaches", "animals", "shit", "parasites", "virus", "monkeys".

GROUP 2: OFFENSIVE (TOXICITY, INSULTS & CONTROVERSIAL TOPICS)
- GENERAL ABUSE: All insults to individuals, profanity, or aggressive language.
- TOPICS: "illegal immigrants", "moslem terrorist", "jewish profit", "black violence" (labeled OFFENSIVE if no extreme dehumanization exists).
...
- NEUTRAL: Using identity words ("muslims", "black", "gay") for news or facts.
- EMPHASIS: "fucking love this", "holy shit", "damn this is good".
"""
...
2. RATIONALE EXTRACTION (CRITICAL FOR SPAN IoU): 
   - Extract CONTINUOUS SEMANTIC BLOCKS that carry the toxicity.
   - For HATE/OFFENSIVE: If the attack is "you are a fucking idiot", extract "fucking idiot", NOT just "idiot". 
   - Ensure the span includes the core toxic context (adjectives + nouns).
