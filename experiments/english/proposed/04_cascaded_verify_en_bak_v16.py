...
2. MINIMAL RATIONALE (CRITICAL FOR SPAN IoU): 
   - Extract ONLY the specific terms (words/phrases) that justify your label.
   - For HATE/OFFENSIVE: Include slurs, dehumanizing words, or aggressive insults.
        ...
        if not self.only_stage2:
            for i, (text, r_res) in enumerate(zip(texts, rated_results)):
                ...
                if self.only_stage1:
                    ...
                    # Phase 11.1: Classic Gating (0.35 - 0.98) - Matched with 0.48 run profile
                    is_judge_needed = (0.35 <= confidence <= 0.98)
