...
- SLURS: "nigger", "kike", "paki", "coon", "spic", "beaner", "chink", "muzzie". Always HATE.
...
- RULE: Use OFFENSIVE for personal insults not targeting an identity group.
...
2. RATIONALE EXTRACTION (CRITICAL FOR SPAN IoU): 
   - Extract BROAD CONTEXTUAL SPANS that carry the toxic intent.
   - Include surrounding context words (pronouns, verbs) if they are part of the attacking phrase.
   - Example: For "you are a dirty immigrant", extract "dirty immigrant" or the whole phrase.
   - NEVER return single fragmented words if they belong to a toxic clause.
