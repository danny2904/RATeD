...
# User requested strict consistency with english/common
try:
...
def evaluate(model, loader, device):
    ...
    # Use dummy dict just for validation loop purpose
...
def main():
    ...
    parser.add_argument("--base_model", type=str, default="distilbert-base-multilingual-cased")
    parser.add_argument("--output_dir", type=str, default="experiments/english/baseline/results/Distil-mBERT")
    ...
    with torch.no_grad():
        for batch in tqdm(test_loader, desc="Testing"):
            ...
            for i in range(len(batch_texts)):
                ...
                item_spans = []
                # Use raw text to extract span strings
