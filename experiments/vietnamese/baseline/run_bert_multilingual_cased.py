...
def main():
    ...
    all_cf1_bin = []
    all_cf1_macro = []
    # Bộ metric dùng chung (ViHateT5 / Table 3): Acc, WF1, MF1 — char-level từ unsafe_spans_indices
    all_vihatet5_acc = []
    all_vihatet5_wf1 = []
    all_vihatet5_mf1 = []
    ...
    for i, item in enumerate(tqdm(test_data, desc="Calculating Metrics")):
        ...
        # Chuẩn chung: Acc, WF1, MF1 (vihatet5_standardized_span_metrics), gold từ unsafe_spans_indices
        ...
        c_acc, c_mf1, c_wf1, c_f1_bin = vihatet5_standardized_span_metrics(pred_char_indices, gold_indices, text)
